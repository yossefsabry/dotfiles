...
keymap("n", "<leader>e", ":NvimTreeFindFileToggle<CR>", term_opts)
-- Resize with arrows
...
-- adding telescope keymaps
vim.keymap.set("n", "<leader>fs", ":Telescope find_files<cr>")
vim.keymap.set("n", "<leader>fg", ":Telescope live_grep<cr>")

-- adding keymap for undoTree
vim.keymap.set('n', '<leader>nn', ":UndotreeToggle<CR>")

-- keymap for harpoon
keymap( "n", "<leader>a", "<cmd>lua require('harpoon.mark').add_file()<cr>", { desc = "Mark file with harpoon" })
